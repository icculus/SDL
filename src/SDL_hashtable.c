...
SDL_HashTable *
SDL_NewHashTable(void *data, const Uint32 num_buckets, const SDL_HashTable_HashFn hashfn,
...
static SDL_INLINE Uint32
calc_hash(const SDL_HashTable *table, const void *key)
{
...
SDL_bool
SDL_InsertIntoHashTable(SDL_HashTable *table, const void *key, const void *value)
{
    SDL_HashItem *item;
...
SDL_bool
SDL_FindInHashTable(const SDL_HashTable *table, const void *key, const void **_value)
{
    const Uint32 hash = calc_hash(table, key);
...
SDL_bool
SDL_RemoveFromHashTable(SDL_HashTable *table, const void *key)
{
    const Uint32 hash = calc_hash(table, key);
...
SDL_bool
SDL_IterateHashTable(const SDL_HashTable *table, const void *key, const void **_value, void **iter)
{
...
SDL_bool
SDL_IterateHashTableKeys(const SDL_HashTable *table, const void **_key, void **iter)
{
...
void
SDL_FreeHashTable(SDL_HashTable *table)
{
    if (table != NULL) {
        void *data = table->data;
        Uint32 i;
